...
| Hand Trajectory Forecasting | `hand_trajectory_forecast` | pass | 8.8173 | pass | 0.4294 |
...
| Cross-Modal Retrieval | `cross_modal_retrieval` | pass | 0.0026 | pass | 0.0026 |
| Cross-Modal Reconstruction | `modality_reconstruction` | pass | -190.6611 | pass | -0.4348 |
| Temporal Order Verification | `temporal_order` | pass | 0.4199 | pass | 0.8252 |
| Multimodal Synchronization Detection | `misalignment_detection` | pass | 0.4998 | pass | 0.7774 |
...
| Imu To Hand Pose | `imu_to_hand_pose` | pass | 0.2295 | pass | 0.2556 |
