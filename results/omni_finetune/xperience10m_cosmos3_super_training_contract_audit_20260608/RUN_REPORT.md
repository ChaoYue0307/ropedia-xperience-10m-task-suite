...
- For camera_pose forward_dynamics targets, use vision velocity/rectified-flow loss under action conditioning; add a policy/inverse target export before presenting supervised action-token prediction.
