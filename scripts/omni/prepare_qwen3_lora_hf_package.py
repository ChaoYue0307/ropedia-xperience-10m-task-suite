...
def render_readme(
    ...
    return "\n".join(
        [
            ...
            "",
            "This adapter belongs to the Ropedia Xperience-10M Task Suite, the",
            "public task and evaluation layer built on the Xperience-10M dataset",
            "released by Ropedia. It is the current Qwen3-Omni v6 LoRA row in",
            "Line 2, the selected-128 comparison line used alongside metadata/raw",
            "baselines and Cosmos3 diagnostics.",
            "",
            "## Run Identity",
            "",
            ...
            *metric_table(metrics),
            ...
            "```",
            "",
            "Also cite the main Ropedia Xperience-10M Task Suite and the upstream",
            "Ropedia Xperience-10M dataset according to their citation guidance.",
            "",
