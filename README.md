...
current matrix has 150 numeric method-task scores out of 180 records.
...
scripts/
  ...
  build_task_method_20_gap_audit.py # builds the explicit 150/180 scored-cell gap ledger
...
docs/
  ...
  data/task_method_20_gap_audit.json # explicit 150/180 scored-cell gap ledger
