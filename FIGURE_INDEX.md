...
| Spatial intelligence presentation photo | `docs/assets/foundation-pipelines/spatial-intelligence-pipeline.png` | 2560 x 1919 | `scripts/render_foundation_pipeline_diagrams.py` | Restored high-resolution presentation photo for the spatial intelligence pipeline track. |
| Human-video world model presentation photo | `docs/assets/foundation-pipelines/human-video-world-model-pipeline.png` | 2560 x 1919 | `scripts/render_foundation_pipeline_diagrams.py` | Restored high-resolution presentation photo for the human-video world-model pipeline track. |
| Vision-language-action presentation photo | `docs/assets/foundation-pipelines/vision-language-action-pipeline.png` | 2560 x 1919 | `scripts/render_foundation_pipeline_diagrams.py` | Restored high-resolution presentation photo for the VLA/action-policy pipeline track. |
