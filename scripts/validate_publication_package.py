...
def required_assets(root: Path) -> dict[str, bool]:
    required = [
        ...
        "docs/data/project_resource_map.json",
        "docs/data/public_reader_map.json",
        ...
        "docs/assets/foundation-pipelines/spatial-intelligence-pipeline.png",
        "docs/assets/foundation-pipelines/human-video-world-model-pipeline.png",
        ...
        "scripts/build_project_resource_map.py",
        ...
        "scripts/omni/eval_cosmos3_super_interaction_text_task.py",
        "scripts/omni/eval_cosmos3_super_retrieval_task_probes.py",
        "scripts/omni/merge_cosmos3_super_future_task_probe_shards.py",
        "scripts/omni/merge_cosmos3_super_interaction_text_task_shards.py",
        "scripts/omni/run_cosmos3_super_future_task_probes_sharded.sh",
        "scripts/omni/run_cosmos3_super_interaction_text_task_sharded.sh",
