...
def render_readme(summary: dict[str, Any], base_model: str, repo_id: str) -> str:
    ...
    return "\n".join(
        [
            ...
            "released by Ropedia. It is published as a separate weight-bearing",
            "Cosmos3-Super forward-dynamics artifact and is not counted as a",
            "20-task matrix method row.",
            "",
            "## Run Identity",
            "",
