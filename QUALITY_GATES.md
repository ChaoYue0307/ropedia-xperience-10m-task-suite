...
| Public surface QA | `python scripts/build_public_surface_qa.py` | `docs/data/public_surface_qa.json` | `pass` | Repo, website, or Hugging Face presentation loses SEO/social metadata, accessible tab semantics, source links, QA links, or public-copy hygiene. |
