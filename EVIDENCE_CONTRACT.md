...
| Public task cards stay readable for non-expert reviewers. | `docs/data/task_surface_integrity.json`, `scripts/validate_task_surface.py`, website task cards/player | Verified task-surface gate | Presentation integrity only; it does not add model quality or new data |
