...
| Foundation-model plan | Current | `FOUNDATION_MODEL_PLAN.md`, `docs/data/foundation_model_plan.json` | Current implemented/diagnostic tracks are Qwen3-Omni v6 and Cosmos3-Super/Nano. Candidate future policy tracks are OpenVLA/openpi/GR00T-style models after robot-compatible action conversion. Long-term, the plan points toward an Xperience-native embodied foundation model after smaller selected-episode stages prove value. |
