...
<head>
  ...
  <title>Single-Episode Explorer | Ropedia Xperience-10M Task Suite</title>
  <meta name="description" content="Interactive window-level explorer for Xperience-10M single-episode diagnostics built on Ropedia's released dataset.">
  ...
  <style>
    ...
    * { box-sizing:border-box; }
    ...
    .language-strip { max-width:900px; display:flex; flex-wrap:wrap; gap:8px; margin-top:22px; font-family:var(--font-btn); font-size:12px; }
    .language-strip a { min-height:32px; display:inline-flex; align-items:center; justify-content:center; padding:0 10px; border:1px solid rgba(204,255,160,.18); border-radius:999px; background:rgba(255,255,255,.05); color:#dfeadc; text-decoration:none; }
    .language-strip a:hover { color:var(--green); border-color:var(--green); background:rgba(204,255,160,.08); }
...
<body>
  <header>
    <div class="wrap nav">
      <a class="brand" href="index.html"><img src="assets/brand/xperience10m-logo-mark-192.png" alt=""><span>Ropedia Xperience-10M Task Suite</span></a>
      <nav class="nav-links"><a href="index.html">Project</a><a href="index.html#raw-sample">Raw Sample</a><a href="single_episode_explorer.html">Explorer</a><a href="data/language_versions.json">Languages</a><a href="data/single_episode_explorer.json">Data JSON</a></nav>
    </div>
  </header>
  <section class="hero">
    <div class="wrap">
      ...
      <div class="language-strip" aria-label="README language versions">
        ...
        <a href="https://github.com/ChaoYue0307/ropedia-xperience-10m-task-suite/blob/main/README.es.md">Español</a>
        <a href="https://github.com/ChaoYue0307/ropedia-xperience-10m-task-suite/blob/main/README.fr.md">Français</a>
        <a href="https://github.com/ChaoYue0307/ropedia-xperience-10m-task-suite/blob/main/README.de.md">Deutsch</a>
        <a href="https://github.com/ChaoYue0307/ropedia-xperience-10m-task-suite/blob/main/README.ja.md">日本語</a>
        <a href="https://github.com/ChaoYue0307/ropedia-xperience-10m-task-suite/blob/main/README.ko.md">한국어</a>
        <a href="https://github.com/ChaoYue0307/ropedia-xperience-10m-task-suite/blob/main/README.pt.md">Português</a>
        <a href="data/language_versions.json">Manifest</a>
      </div>
      <div class="stats">
