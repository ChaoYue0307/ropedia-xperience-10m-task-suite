...
scripts/
  ...
  build_task_method_20_gap_audit.py # builds the explicit 153/180 scored-cell gap ledger
...
docs/
  ...
  data/task_method_20_gap_audit.json # explicit 153/180 scored-cell gap ledger
