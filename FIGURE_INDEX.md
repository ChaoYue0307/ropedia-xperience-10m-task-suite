...
| Unified 20-task model radar | `docs/assets/charts/unified_task_model_radar.svg` | 2600 x 2300 | `scripts/build_unified_task_model_radar.py` | Grouped small-multiple 20-task radar board for all nine methods, separating single-episode, 128-episode metadata/text, 128-episode raw-feature, and foundation-model rows while preserving task keys and proxy notes. |
| Single-episode 20-task model radar | `docs/assets/charts/single_episode_task_model_radar.svg` | 2600 x 2300 | `scripts/build_unified_task_model_radar.py` | Twenty-axis split radar for the one public-sample episode, comparing Minimal and Neural MLP as two complete 20/20 scored polygons. |
| 128-episode 20-task model radar | `docs/assets/charts/episode128_task_model_radar.svg` | 2600 x 2300 | `scripts/build_unified_task_model_radar.py` | Grouped 20-task radar for selected 128-episode methods: metadata/text baselines, raw-feature simple/NN, Qwen3-Omni, Cosmos3-Super, and Cosmos3-Nano with local legends and proxy notes. |
