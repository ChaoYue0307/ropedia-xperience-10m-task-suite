...
FIGURES = [
    ...
    },
    {
        ...
        "role": "Restored high-resolution presentation photo for the spatial intelligence pipeline track.",
    ...
    },
    {
        ...
        "role": "Restored high-resolution presentation photo for the human-video world-model pipeline track.",
        "source_script": "scripts/render_foundation_pipeline_diagrams.py",
        "surface": "README, website, HF Space, artifact dataset, model card",
    },
    {
        ...
        "role": "Restored high-resolution presentation photo for the VLA/action-policy pipeline track.",
        "source_script": "scripts/render_foundation_pipeline_diagrams.py",
        "surface": "README, website, HF Space, artifact dataset, model card",
    },
    {
