...
# Parallel CPU export followed by 8-process Qwen3-Omni LoRA training.
# This keeps held-out test episodes sealed and is intended for progressive
# train/validation runs while the full 128-episode pilot is still staging.
...
RUN_ID="${RUN_ID:-xperience10m_qwen3_omni_trainval_parallel_8gpu}"
